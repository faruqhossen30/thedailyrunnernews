<footer>
    <div class="footer">
        <div class="container">
            <div class="row">
                <div style="margin: 0 0 10px 0; width: 100%;  text-align: center; font-size: 15px; padding: 10px">
                    <div style="font-size: 18px; font-weight: bold">সম্পাদক ও প্রকাশক :</div>
                    ...
                    <a target="_blank" href="http://www.i2softbd.com"><span
