                    ...
                    <div class="app-search-box dropdown">
                        ...
                        <div class="dropdown-menu dropdown-lg" id="search-dropdown">
                            ...
                            <div class="notification-list">
                                ...
                                <a href="javascript:void(0);" class="dropdown-item notify-item">
                                    <div class="d-flex">
                                        <img class="d-flex me-2 rounded-circle" src="{{asset('backend/assets/images/images/users/avatar-2.jpg')}}" alt="Generic placeholder image" height="32">
                                        <div>
                                ...
                                <a href="javascript:void(0);" class="dropdown-item notify-item">
                                    <div class="d-flex">
                                        <img class="d-flex me-2 rounded-circle" src="{{asset('backend/assets/images/images/users/avatar-5.jpg')}}" alt="Generic placeholder image" height="32">
                                        <div>
                    ...
                    <div class="noti-scroll" data-simplebar>
                        ...
                        <a href="javascript:void(0);" class="dropdown-item notify-item">
                            <div class="notify-icon">
                                <img src="{{asset('backend/assets/images/images/users/avatar-2.jpg')}}" class="img-fluid rounded-circle" alt="" /> </div>
                        ...
                        <a href="javascript:void(0);" class="dropdown-item notify-item">
                            <div class="notify-icon">
                                <img src="{{asset('backend/assets/images/images/users/avatar-4.jpg')}}" class="img-fluid rounded-circle" alt="" /> </div>
